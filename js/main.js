...
(function() {
  ...
  $(document).ready(function() {
    ...
    if ($('body').hasClass('chapter-3-working-for-the-nest-egg')) {
      (function() {
        var $estimated_income, $financially_unprepared_chart, $financially_unprepared_chart_points, $investor_underperforms_chart, $investor_underperforms_chart_points, $user_age, calculate_retirement_savings, financially_unprepared_chart_top, investor_underperforms_chart_top;
